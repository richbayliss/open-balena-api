...
* Add feature & tests [Rich Bayliss]
* Refactor tests to support new model [Rich Bayliss]
* Add model changes [Rich Bayliss]
* Expose SYSTEM_APPS via config [Rich Bayliss]
